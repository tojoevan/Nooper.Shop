...
defined('system_path') or define('system_path', 'shop');
...
defined('bootstrap_path') or define('bootstrap_path', 'init');
...
/**
 * boolean function is_function_file_named_regular(string $data)
 */
...
/**
 * boolean function is_class_file_named_regular(string $data)
 */
...
/**
 * boolean function is_config_file_named_regular(string $data)
 */
...
/**
 * void function load_function_files(string $path)
 */
...
/**
 * void function load_library_files(string $path)
 */
...
/**
 * void function load_config_files(string $path)
 */
...
/**
 * function void load_core_files(void)
 */
...
/**
 * function void load_system_files(void)
 */
