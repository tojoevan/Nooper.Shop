 ...
 * Part 9: Express
 */
 insert into `express_carriage_default_params`(`id`, `carriage_mode`, `inner_free_money`, `inner_ceil_money`) values
		(1, 'global', 0.00, 0.00);
		
insert into `express_address_regions`(`id`, `code`, `name`, `basic_carriage`, `each_plus_carriage`, `tax_rate`, `status`) values
		(1, 'China', '中国'),
		(2, 'United States', '美国'),
		(3, 'Japan', '日本');
...
insert into `express_address_cities`(`id`, `province_id`, `name`) values
		(1, 1,'密云区'),
		(2, 1,'朝阳区'),
		(3, 1,'昌平区'),
		(4, 1,'平谷区'),
